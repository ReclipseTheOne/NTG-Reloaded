...
mods.jei.JEI.removeAndHide(<libvulpes:productplate:8>);
mods.jei.JEI.removeAndHide(<libvulpes:productplate:9>);

//OreDicc
val SiliconWafer = <ore:waferSilicon>;

SiliconWafer.add(<gregtech:meta_item_1:371>);

val SiliconBoule = <ore:bouleSilicon>;

SiliconBoule.add(<gregtech:meta_item_1:361>);
